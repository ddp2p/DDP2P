...
public class PluginRegistration {
	...
	class RegisterPlugins extends util.DDP2P_ServiceRunnable {
		...
		*/
		...
		try {
			...
			try {
				...
				PluginRegistration.registerPlugin(i.plugin_GID, i.plugin_name, i.plugin_info, i.plugin_url,
						i.mTableCellRenderer,
						i.mTableCellEditor);
