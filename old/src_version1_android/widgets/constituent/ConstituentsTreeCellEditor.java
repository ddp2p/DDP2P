     		...
     		if((node.n_data==null)||(node.n_data.neighborhoodID<0)) return false;
      		if(node.n_data.global_nID == null)	return true;
      			...
      			if(DD.EDIT_VIEW_UNEDITABLE_NEIGHBORHOODS)
      				Application_GUI.warning(_("Cannot edit signed neighborhoods! Create a new one."), _("Not editable"));
      			else
      				Application_GUI.warning(_("Cannot edit signed neighborhoods! Create a new one."+"\n"+
