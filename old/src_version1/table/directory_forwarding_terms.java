...
public class directory_forwarding_terms {
	...
	public static final String dir_addr = "dir_addr";
	...
	public static final int F_DIR_ADDR = 6;
	public static final int F_SERVICE = 7;
	public static final int F_PRIORITY_TYPE = 8;
