...
import WSupdate.DdWSPortType;
import WSupdate.DdWS;
import WSupdate.VersionInfo;
import WSupdate.Downloadable;
import WSupdate.TestDef;
import WSupdate.Test;
import WSupdate.TesterInfo;
import WSupdate.History;
...
class Request extends ASN1.ASNObj {
	Calendar date;
	String url;
	String peerGID;
...
// 	}
    public static void main(String[] args) {
    	...
    	while(response==null){  	
	    	response = getWSVersionInfo(url,"gid:1111",config.DD.getMyPeerSK(),context);
	    	if (response!=null){
...
//        System.out.println("Web service response getUrl: " + "  "+d.getUrl() + d.getFilename() );
    ...
    public static updates.VersionInfo getWSVersionInfo(URL url, String GID, SK myPeerSK, Hashtable<Object,Object> context){
