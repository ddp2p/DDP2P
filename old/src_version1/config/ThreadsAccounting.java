...
public class ThreadsAccounting extends AbstractTableModel implements TableModel {
	...
	static final String CREATION = _("CREATION");
	static final String REPLICATED_CREATION = _("2nd CREATION");
	/**
	...
	public static void ping(String state) {
		...
		synchronized (monitor_running) {
			if ((old_info = running.get(crt)) == null) {
				...
				old_info.name = _("Unknown Thread:")+" "+crt.getName();
	...
	String columnNames[]={_("Name"),_("State"),_("Hot"),_("Creation"),_("Ping")};
