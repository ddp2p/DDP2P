...
public class ChatMessage extends ASN1.ASNObj {
     ...
     public Encoder getEncoder() {
         ...
         if (received_out_of_sequence != null) {//BigInteger[] bigIntArray=null; received_out_of_sequence.toArray(bigIntArray); 
                                                enc.addToSequence(Encoder.getEncoder(received_out_of_sequence).setASN1Type(DD.TAG_AC10));
                                               }
         return enc;
     }
     ...
     public ChatMessage decode(Decoder dec) throws ASN1DecoderFail {
         ...
         if (d.getTypeByte() == DD.TAG_AC10) received_out_of_sequence =  d.getFirstObject(true).getSequenceOfAL(Encoder.TAG_BIT_STRING, BigInteger.valueOf(0) );// new ArrayList<BigInteger>(Arrays.asList(d.getFirstObject(true).getBNIntsArray()));
         return this;
     }
 }