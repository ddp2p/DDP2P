			...
			case PluginRequest.MSG:
				...
				if((msg==null)||(msg.plugin_GID==null)||(msg.peer_GID==null)) {
					if(DD.WARN_OF_INVALID_PLUGIN_MSG)
						Application_GUI.warning(_("Plugin: "+plugin_name(msg.plugin_GID)+" sends unspecified request"), _("Invalid plugin message"));
				...
				if(DD.WARN_OF_UNUSED_PEERS && (pca == null)){
					D_Peer peer;
					peer = D_Peer.getPeerByGID(msg.peer_GID, true, true);
					if(!peer.component_preferences.used)
						Application_GUI.warning(_("Plugin: "+plugin_name(msg.plugin_GID)+" sends request to blocked/unused user"),
