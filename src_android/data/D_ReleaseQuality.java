...
public class D_ReleaseQuality extends ASN1.ASNObj{
	...
	public static void main(String[]args){
		if(args.length!=1){
			Application_GUI.warning(_("Bad parameters list: need xml_file_name;"), _("RELEASE QUALITY"));
			return;
		}
		File xml = new File(args[0]);
		if(!xml.isFile()){
			Application_GUI.warning(_("Bad parameters list: need existing xml_file_name;"), _("RELEASE QUALITY"));
			return;			
		}
