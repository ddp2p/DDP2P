...
public class D_TesterSignedData extends ASN1.ASNObj{
	D_TesterInfo tester_info;
	D_ReleaseQuality quality_release[];
	VersionInfo version_info;
	public D_TesterSignedData() {}
	public D_TesterSignedData(VersionInfo a, int idx) {
		version_info = a;
	...
	public void generateXMLFile (String fileName){
		if(fileName == null){
			Application_GUI.warning(_("file name cannot be null ,need xml_file_name;"), _("TESTER GENERATE XML"));
			return;
		}
		try{
	...
	@Override
	public D_TesterSignedData decode(Decoder dec) throws ASN1DecoderFail {
