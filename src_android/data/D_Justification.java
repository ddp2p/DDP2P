...
public class D_Justification extends ASNObj{
	...
	public byte[] sign(String signer_GID) {
		...
		if(sk==null) {
			...
			Application_GUI.warning(_("No secret key to sign motion, no constituent GID"), _("No Secret Key!"));
			return null;
		}
		...
		if((this.justification_ID == null ) && (this.global_justificationID != null)) {
			...
			if((this.justification_ID != null ) && (this.global_justificationID != null)) {
				...
				if((tmp!=null) && (this.justification_ID.compareTo(tmp) != 0)) {
					Application_GUI.warning(Util._("Double Justification. Modify or delete it."), Util._("Cannot save duplicated justification!"));
					return -1; 
				}
			}
		}
