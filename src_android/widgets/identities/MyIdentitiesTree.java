...
public class MyIdentitiesTree extends JTree implements TreeExpansionListener,  TreeWillExpandListener, MouseListener, ActionListener{
    ...
    void preparePopup(){
    	ImageIcon addicon = Util_GUI.createImageIcon("icons/add.png",_("add an item"));
    	ImageIcon delicon = Util_GUI.createImageIcon("icons/remove.png",_("delete an item"));

    	popup_add = new JPopupMenu();
    	// add
    	addAction = new IdentityAddAction(this, _("Add"),addicon,_("Add new profile."),_("You may add new profile."),KeyEvent.VK_A);
    	m_menu_add_id = new JMenuItem(addAction);//_("Add")
    	popup_add.add(m_menu_add_id);

    	popup_leaf = new JPopupMenu();
    	// add
    	delAction = new IdentityDelAction(this, _("Del"),delicon,_("Dell property."),_("You may delete this information about yourself."),KeyEvent.VK_D);
    	m_menu_del_prep = new JMenuItem(delAction);//_("Delete");
    	popup_leaf.add(m_menu_del_prep);
    	
    	cmdAction = new IdentityCustomAction(this, _("Move To Bottom"),delicon,_("Down property."),_("Bottom."),KeyEvent.VK_B,IdentityCustomAction.CMD_BOTTOM);
    	m_menu_del_prep = new JMenuItem(cmdAction);//_("Delete");
    	popup_leaf.add(m_menu_del_prep);
    	
    	cmdAction = new IdentityCustomAction(this, _("Move To Top"),delicon,_("Up property."),_("Top."),KeyEvent.VK_T,IdentityCustomAction.CMD_UP);
    	m_menu_del_prep = new JMenuItem(cmdAction);//_("Delete");
    	popup_leaf.add(m_menu_del_prep);
    	...
    	// add
    	addPAction = new IdentityPropertyAddAction(this, _("Add property"),addicon,_("Add property."),_("You may add new information about yourself."),KeyEvent.VK_A);
    	m_menu_add_prop = new JMenuItem(addPAction);//_("Add")
    	popup.add(m_menu_add_prop);
    	// delete
    	delAction = new IdentityDelAction(this, _("Delete Identity"),delicon,_("Dell identity."),_("You may delete this information about yourself."),KeyEvent.VK_D);
    	m_menu_del_id = new JMenuItem(delAction);//_("Delete");
    	popup.add(m_menu_del_id);

    	setDefAction = new IdentitySetDefAction(this, _("Set As Default"),null,_("Set profile as default."),_("Set this profile as default."),KeyEvent.VK_S);
    	m_menu_set_def = new JMenuItem(setDefAction);//_("Add")
    	popup.add(m_menu_set_def);
    	//
    	unsetDefAction = new IdentityUnSetDefAction(this, _("UnSet As Default"),null,_("UnSet profile as default."),_("UnSet this profile as default."),KeyEvent.VK_U);
    	m_menu_unset_def = new JMenuItem(unsetDefAction);//_("Add")
    	popup.add(m_menu_unset_def);
    	//
    	setCurrentAction = new IdentitySetCurrentAction(this, _("Set Current"),null,_("Set profile as current."),_("Set this profile as default."),KeyEvent.VK_S);
    	m_menu_set_current = new JMenuItem(setCurrentAction);//_("Add")
    	popup.add( m_menu_set_current);
    	//
    	unsetCurrentAction = new IdentityUnSetCurrentAction(this, _("UnSet Current"),null,_("UnSet profile as current."),_("UnSet this profile as default."),KeyEvent.VK_S);
