...
public class TermsCustomAction extends DebateDecideAction {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if(model.peerID==-1){
    		Application_GUI.warning(_("Select a peer first!"), _("Select a peer first!"));
    		return;
    	}
    	...
    	if(cmd == M_ADD) {
    		...
    		try {
				Application.db.insert(table.directory_forwarding_terms.TNAME,
						new String[]{table.directory_forwarding_terms.peer_ID,table.directory_forwarding_terms.peer_instance_ID,table.directory_forwarding_terms.dir_domain,table.directory_forwarding_terms.dir_tcp_port, table.directory_forwarding_terms.priority, table.directory_forwarding_terms.service,table.directory_forwarding_terms.priority_type},
