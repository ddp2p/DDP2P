...
class OrgsCustomAction extends DebateDecideAction {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if(command == C_RCOLUMN) {
        	...
        	int col = Application_GUI.ask(_("Add"), _("Columns"), Arrays.copyOf(model.columnNames, model.columnNames.length, new Object[]{}.getClass()), null, null);
...
class OrgsModel extends AbstractTableModel implements TableModel, DBListener {
	...
	String columnNames[]={_("Name"),_("Founder"),_("Category"),_("Constituents"),_("Activity"),_("Hot"),_("News")
			//,_("Plugins")
			};
