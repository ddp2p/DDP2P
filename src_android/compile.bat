...
widgets\app\*.class util\db\*.class util\email\*.class
...
widgets\*.java widgets\peers\*.java widgets\identities\*.java widgets\constituent\*.java widgets\wireless\*.java ^
...
widgets\app\*.java util\db\*.java util\email\*.java
...
widgets\*.class widgets\app\*.class widgets\census\*.class widgets\components\*.class widgets\constituent\*.class ^
...
util\db\*.class util\email\*.class
