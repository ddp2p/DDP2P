...
//		for (RequestData a : rd) if ( ! a.empty() ) return false;
	...
	*/
	...
	public static final String sql_orgs_inferred_queried_for_peer =
			...
			" JOIN "+table.peer_org_inferred.TNAME+" AS p ON(p."+table.peer_org_inferred.organization_ID+"=o."+table.organization.organization_ID+") "+
			" WHERE "+table.peer_org_inferred.peer_ID+"=? AND o."+table.organization.specific_requests+" IS NOT NULL";
