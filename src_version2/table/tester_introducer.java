...
public class tester_introducer {
	...
	public static final String tester_introducer_LID="tester_introducer_ID";// primary key
	...
	public static final String signature="signature"; //signature of date,weght and tester_GID (from tester table if exist??) 
	...
	public static final String fields_tester_introducer = fields_tester_introducer_no_ID+","+tester_introducer_LID;
	...
	public static final int F_INTRODUCER_PEER_GID = 1;
