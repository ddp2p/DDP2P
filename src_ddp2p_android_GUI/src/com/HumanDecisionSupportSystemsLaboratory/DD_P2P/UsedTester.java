...
public class UsedTester extends Fragment{
	...
	public static UsedTester newInstance() {
		UsedTester ut = new UsedTester();
		return ut;
	}
	...
	private class KnownAdapter extends ArrayAdapter<ServerItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (v == null) {
				...
				v = inflater.inflate(R.layout.update_used_server_list, null);
			}
			...
			if (item != null) {
				...
				TextView name = (TextView) v
						.findViewById(R.id.update_used_server_list_name);
				EditText score = (EditText) v
						.findViewById(R.id.update_used_server_list_score);
