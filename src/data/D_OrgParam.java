 ...
 */
	...
	public static D_OrgParam  init(D_OrgParam op, ArrayList<Object> fe) throws P2PDDSQLException {
			...
			op.can_be_provided_later = "1".equals(Util.getString(fe.get(table.field_extra.OPARAM_LATER)));
			op.certificated = "1".equals(Util.getString(fe.get(table.field_extra.OPARAM_CERT)));
			...
			op.required = "1".equals(Util.getString(fe.get(table.field_extra.OPARAM_REQ)));
	...
	public Encoder getEncoder() {
		...
		enc.addToSequence(new Encoder(global_field_extra_ID));
	...
	public static String makeGID(
		...
		return "F:"+Util.stringSignatureFromByte(enc.getBytes());
	}
}