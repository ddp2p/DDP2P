...
public class D_TermsInfo extends ASN1.ASNObj{
	...
	public D_TermsInfo(ArrayList<Object> _u) {
		init(_u);
	}
...
*/
	...
	public void init(ArrayList<Object> _u){
	    ...
	    dir_addr = Util.getString(_u.get(table.directory_forwarding_terms.F_DIR_ADDR));
	...
	public void storeNoSync(String cmd) throws P2PDDSQLException {
		...
		params[table.directory_forwarding_terms.F_DIR_ADDR] = this.dir_addr;
