...
public class DirModel extends AbstractTableModel implements TableModel, DBListener{
	...
	public static final int TABLE_COL_MODE = 5;
	public static final int TABLE_COL_EXPIRATION = 6;
	...
	DirTable dirTable;
	String columnNames[]={_("Name"),_("Topic"),_("AD"),_("Plaintext"),_("Payment"),_("Services"),_("Expiration")};
	...
	public Class<?> getColumnClass(int col) {
		if(col == TABLE_COL_NAME || col==TABLE_COL_MODE || col == TABLE_COL_EXPIRATION) return getValueAt(0, col).getClass();// ComboBoxRenderer.class; // dropdown list
...
//		}
	...
	public JComboBox getComboBox(String gid){
		if(DEBUG) System.out.println("DirModel: getComboBox: start:");
		String sql = "SELECT "+peer.global_peer_ID+" ,"+ peer.name+" FROM "+peer.TNAME+";";
