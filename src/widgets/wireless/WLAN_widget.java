...
*/
	...
	JPopupMenu getPopup(int model_row, int col){
    	...
    	JPopupMenu popup = new JPopupMenu();
       	...
       	rAction = new WirelessCustomAction(this, _("Refresh!"),addicon,_("Refresh."),_("Refresh the data."), KeyEvent.VK_A, false, WirelessCustomAction.REFRESH);
     	rAction.putValue("row", new Integer(model_row));
    	menuItem = new JMenuItem(rAction);
    	popup.add(menuItem);
    	
       	rAction = new WirelessCustomAction(this, _("Unselect"),addicon,_("Unselect."),_("Unselect."), KeyEvent.VK_U, false, WirelessCustomAction.UNSELECT);
     	rAction.putValue("row", new Integer(model_row));
    	menuItem = new JMenuItem(rAction);
    	popup.add(menuItem);
    	
       	rAction = new WirelessCustomAction(this, _("DisConfigure"),addicon,_("DisConfigure (Linux: restart manager, Windows: dhcp)."),_("Disconfigure."), KeyEvent.VK_D, false, WirelessCustomAction.DISCONFIGURE);
     	rAction.putValue("row", new Integer(model_row));
    	menuItem = new JMenuItem(rAction);
    	popup.add(menuItem);
...
class WlanModel  extends AbstractTableModel implements TableModel, DBListener {
	...
	String columnNames[]={_("Interface Name"),_("Current IP"),_("SSID"),_("Select Interface")};
