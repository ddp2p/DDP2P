...
*/
    ...
    JPopupMenu getPopup(int row, int col){
    	...
    	aAction = new TermsCustomAction(this, _("Add a Term"), addicon,_("Add a Term"), _("AddTerm"),KeyEvent.VK_A, TermsCustomAction.M_ADD);
    	aAction.putValue("row", new Integer(row));
    	menuItem = new JMenuItem(aAction);
    	popup.add(menuItem);
    	
    	aAction = new TermsCustomAction(this, _("Move UP"), upicon,_("Move UP"), _("MoveUP"),KeyEvent.VK_U, TermsCustomAction.M_UP);
    	aAction.putValue("row", new Integer(row));
    	menuItem = new JMenuItem(aAction);
    	popup.add(menuItem);
    	
    	aAction = new TermsCustomAction(this, _("Move Down"), downicon,_("Move Down"), _("MoveDown"),KeyEvent.VK_O, TermsCustomAction.M_DOWN);
    	aAction.putValue("row", new Integer(row));
    	menuItem = new JMenuItem(aAction);
    	popup.add(menuItem);
    	
    	aAction = new TermsCustomAction(this, _("Delete"), delicon,_("Delete Mirror"), _("Delete"),KeyEvent.VK_D, TermsCustomAction.M_DELETE);
    	aAction.putValue("row", new Integer(row));
    	menuItem = new JMenuItem(aAction);
    	popup.add(menuItem);
