...
class ECC extends ASNObj {
	...
	@Override
	public boolean equals (Object __curve) {
		if (!(__curve instanceof ECC)) return false;
		ECC _curve = (ECC) __curve;
		if (p == null) return false;
		if (a == null) return false;
		if (b == null) return false;
		if (!a.equals(_curve.a)) return false;
		if (!b.equals(_curve.b)) return false;
		if (!p.equals(_curve.p)) return false;
		return true;
	}
	/**
	 * 
