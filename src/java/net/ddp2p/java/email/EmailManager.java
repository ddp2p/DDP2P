...
import net.ddp2p.common.util.ByteDataSource;
import net.ddp2p.common.util.DBInterface;
import net.ddp2p.common.util.DD_EmailableAttachment;
...
class EmailManager {
	...
	public static void verify(long constituent_ID) {
			DD_IdentityVerification_Request iv = new DD_IdentityVerification_Request();
			iv.verified = D_Constituent.getConstByLID(constituent_ID, true, false); 
			...
			net.ddp2p.common.table.constituent_verification.add(constituent_ID, iv.r.toString(),iv.d);
			sendEmail(iv);
	}
	public static void setEmailPassword(Object current_id_branch, String object) {
		try {
			DD.setAppTextNoSync(net.ddp2p.java.email.EmailManager.SMTP_PASSWORD, object);
		} catch (P2PDDSQLException e) {
			e.printStackTrace();
		}
	}
	public static void setEmailUsername(Object current_id_branch, String object) {
		try {
			DD.setAppTextNoSync(net.ddp2p.java.email.EmailManager.SMTP_USERNAME, object);
		} catch (P2PDDSQLException e) {
			e.printStackTrace();
		}
	}
	public static void setSMTPHost(Object current_id_branch, String object) {
		try {
			DD.setAppTextNoSync(net.ddp2p.java.email.EmailManager.SMTP_HOST, object);
		} catch (P2PDDSQLException e) {
			e.printStackTrace();
		}
	}
	public static String getSMTPHost(Object current_id_branch) {
		try {
			return DD.getExactAppText(net.ddp2p.java.email.EmailManager.SMTP_HOST);
		} catch (P2PDDSQLException e) {
			e.printStackTrace();
			return null;
		}
	...
	public static String getEmailUsername(Object current_id_branch) {
		try {
			return DD.getExactAppText(net.ddp2p.java.email.EmailManager.SMTP_USERNAME);
		} catch (P2PDDSQLException e) {
			e.printStackTrace();
			return null;
		}
