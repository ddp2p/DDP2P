...
// NOTE: Same as Request version, just different variable names.
// If PEER is also the same, may want to just have one class.
...
public class MapOpCodeInfoResponse implements OpCodeInfo
{
    ...
    public void generateMappingNonce()
    {
        ...
        // Only take the first 12 bytes (may include sign bit)
