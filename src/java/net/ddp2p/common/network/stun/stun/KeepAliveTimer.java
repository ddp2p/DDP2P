...
public class KeepAliveTimer extends Attribute
{
    ...
    public static final byte PLACEHOLDER = 0; // For code readability.
	...
	int id;
	int time;	  // t
	double deltaT; // delta t (re-name to delta?)
	int k;
	byte incrementType; // 0 = linear, 1 = geometric
	...
	public int getK() { return k; } // counter provided by the server.
	...
	public byte[] getBytes()
    {
		...
		byte flagByte = 0;
		// TODO: Refactor to use booleans or actual values.
	...
	// TODO: Investigate how MappedAddress and XorMappedAddress are using the data array - may be skipping a byte.
    ...
    {
		this.length = 36; // Constant Length.
	}
