...
public class SynchronizedTime
{
    ...
    private boolean threadStop = false; // Used for testing to stop the observer thread when
                                        // the calculation thread is finished.
    ...
    public synchronized void resetThreadStop() { this.threadStop = false; } // Probably not needed.
