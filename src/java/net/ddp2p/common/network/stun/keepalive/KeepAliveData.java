...
public class KeepAliveData {
	...
	private int k = 1;				
	private byte incrementType = 0;  
	private byte usesStarterMessage = 0; 
	private byte direction = 0;
	private int maxRepeats = 0;
	private int currentRepeats = 2; 
    ...
    public void resetCurrentRepeats() { this.currentRepeats = 1; } 
