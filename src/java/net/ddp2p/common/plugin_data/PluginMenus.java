...
class PluginMenus{
	...
	String plugin_ID;
	String plugin_name;
	public ArrayList<Object> plugin_menu_action = new ArrayList<Object>(); //Action>();
	public ArrayList<Object> plugin_menu_item = new ArrayList<Object>(); //JMenuItem>();
	public PluginMenus(String plugin_ID, String plugin_name){
		this.plugin_ID = plugin_ID;
		this.plugin_name = plugin_name;
	}
	void addMenu(int col, // JMenuItem
			Object plugin_menu_item){
		this.plugin_menu_item.add(plugin_menu_item);		
	}
	void addAction(int col, //Action
	...
	public PluginMenus clone() {
		...
		for(Object pa: plugin_menu_action) result.plugin_menu_action.add(pa); // Action
		for(Object ma: plugin_menu_item) result.plugin_menu_item.add(ma); // JMenuItem
		return result;
	}
	/**
	 * Merge into mn
	...
	public static Hashtable<String, PluginMenus> merge(
	   	...
	   	for(String plug_gid : mn2.keySet()) {
     		...
     		for(Object pa: pm2.plugin_menu_action){ // Action
     			if(!new_pm.plugin_menu_action.contains(pa)) new_pm.plugin_menu_action.add(pa);
    		for(Object ma: pm2.plugin_menu_item) //JMenuItem
