...
public class DD {
	...
	*/
	...
	// Limit used for sending messages
	public static int MTU = 1472-200;//-169; //32000; // 1472 maximum supported by jnetpcap assuming 1500 -IP - ETH - UDP
	...
	/** Limits Used for security at recipient */
	public static int UDP_MAX_FRAGMENTS = 10000; //UDP_MAX_MSG_LENGTH / MTU; //10000;//100;
