...
public class ASNSyncPayload extends ASNObj{
	...
	public static boolean STREAMING_SEND_CREATOR_IN_PEER = true; 
	public static boolean STREAMING_SEND_NEIGHBORHOOD_IN_CONSTITUENT = false;
	public String version="1";
	public Calendar upToDate; 
	public ASNDatabase tables; 
	public D_Organization orgData[]; 
	public OrgCRL orgCRL;   
	public String responderGID; 
	public D_PeerInstance peer_instance; 
	public ASNPluginInfo plugins[]; 
	public D_PluginData plugin_data_set; 
	public WB_Messages requested; 
	public ArrayList<String> dictionary_GIDs =  new ArrayList<String>();
	public SpecificRequest advertised;   
	public ArrayList<OrgInfo> advertised_orgs; 
	public ArrayList<ResetOrgInfo> changed_orgs; 
	...
	public static void preparePeerDictionary(D_Peer p,
			ArrayList<String> dictionary_GIDs) {
		if (p.component_basic_data.globalID != null)  
	...
	public static void prepareTranDictionary(D_Translations e, ArrayList<String> dictionary_GIDs) {
		if(e.global_organization_ID!=null) 
				addToDictionaryGetIdxS(dictionary_GIDs, e.global_organization_ID);
		if(e.global_constituent_ID!=null) 
...
ASNSyncPayload := IMPLICIT [APPLICATION 8] SEQUENCE {
	...
	public ASNSyncPayload decode(Decoder decoder) throws ASN1DecoderFail {
		...
		if(dec.getTypeByte()==DD.TAG_AC10) peer_instance=new D_PeerInstance().decode(dec.getFirstObject(true)); 
