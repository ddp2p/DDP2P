...
public class DD_Mirrors extends ASNObj implements StegoStructure {
	...
	public void setBytes(byte[] asn1) throws ASN1DecoderFail {
		...
		if (empty()) throw new net.ddp2p.ASN1.ASNLenRuntimeException("Empty mirrors");
	}
...
//	}
	...
	public static void main(String[] args){
		...
		try {
			...
			net.ddp2p.common.util.EmbedInMedia.saveSteganoBMP(file, mirrors.encode(), mirrors.getSignShort());
		} catch (P2PDDSQLException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
