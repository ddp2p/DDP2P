...
import net.ddp2p.common.data.ASNConstituentOP;
...
public class ConstituentHandling {
	...
	static String sql_get_const_ops_min_max_no_terminator =
		...
		" WHERE c."+net.ddp2p.common.table.constituent.sign+" IS NOT NULL AND "
		+ " o."+net.ddp2p.common.table.organization.broadcasted+" <> '0' "
		+ " AND c."+net.ddp2p.common.table.constituent.broadcasted+" <> '0' "
			+" AND c."+net.ddp2p.common.table.constituent.organization_ID+" = ? " +
					" AND c."+net.ddp2p.common.table.constituent.arrival_date+" > ? AND c."+net.ddp2p.common.table.constituent.arrival_date+" <= ?" +
				" GROUP BY c."+net.ddp2p.common.table.constituent.arrival_date;
	/**
	 * Selects constituent data where the organization and the constituent are not blocked,
	...
	public static String getConstituentOPsDate(String last_sync_date, String maxDate, OrgFilter ofi, HashSet<String> orgs, int limitConstituentLow) throws P2PDDSQLException {
		...
		String sql_no_filter = "SELECT c."+net.ddp2p.common.table.constituent.arrival_date+", COUNT(*) "
			+", o."+net.ddp2p.common.table.organization.global_organization_ID +", c."+net.ddp2p.common.table.constituent.organization_ID +
				" FROM "+net.ddp2p.common.table.constituent.TNAME+" as c "
		...
		String sql_filter = "SELECT c."+net.ddp2p.common.table.constituent.arrival_date+", COUNT(*) "
			+", o."+net.ddp2p.common.table.organization.global_organization_ID +", c."+net.ddp2p.common.table.constituent.organization_ID +
				" FROM "+net.ddp2p.common.table.constituent.TNAME+" as c "
				+ " LEFT JOIN  "+net.ddp2p.common.table.organization.TNAME+" as o ON (o."+net.ddp2p.common.table.organization.organization_ID+" = c."+net.ddp2p.common.table.constituent.organization_ID+")  "
			+ " WHERE c."+net.ddp2p.common.table.constituent.sign+" IS NOT NULL AND "
	...
	public static String getConstituentOPsDate(String last_sync_date, OrgFilter ofi, HashSet<String> orgs, int limitConstituentLow) throws P2PDDSQLException {
		...
		String sql_no_filter =
			"SELECT c."+net.ddp2p.common.table.constituent.arrival_date+", COUNT(*) " +", o."+net.ddp2p.common.table.organization.global_organization_ID +", c."+net.ddp2p.common.table.constituent.organization_ID +
				...
				+ " o."+net.ddp2p.common.table.organization.broadcasted+" <> '0' "
				+ " AND c."+net.ddp2p.common.table.constituent.broadcasted+" <> '0' "
			+" AND c."+net.ddp2p.common.table.constituent.arrival_date+" > ? GROUP BY c."+net.ddp2p.common.table.constituent.arrival_date+" LIMIT "+(1+limitConstituentLow)+";";
		String sql_filter =
			"SELECT c."+net.ddp2p.common.table.constituent.arrival_date+", COUNT(*) " +", o."+net.ddp2p.common.table.organization.global_organization_ID +", c."+net.ddp2p.common.table.constituent.organization_ID +
					" FROM "+net.ddp2p.common.table.constituent.TNAME+" as c "
					+ " LEFT JOIN  "+net.ddp2p.common.table.organization.TNAME+" as o ON (o."+net.ddp2p.common.table.organization.organization_ID+" = c."+net.ddp2p.common.table.constituent.organization_ID+")  "
