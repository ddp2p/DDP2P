...
import net.ddp2p.common.WSupdate.DdWS;
import net.ddp2p.common.WSupdate.DdWSPortType;
import net.ddp2p.common.WSupdate.Downloadable;
import net.ddp2p.common.WSupdate.History;
import net.ddp2p.common.WSupdate.Test;
import net.ddp2p.common.WSupdate.TestDef;
import net.ddp2p.common.WSupdate.TesterInfo;
import net.ddp2p.common.WSupdate.VersionInfo;
