...
import net.ddp2p.common.hds.DirectoryServerCache;
public class SaverThreadsConstants {
	...
	public static final int ATTEMPTS_ON_ERROR = 1; 
	...
	public static final long SAVER_SLEEP_WORKER_BETWEEN_MOTION_MSEC = -1; 
	...
	public static final long SAVER_SLEEP_BETWEEN_ORGANIZATION_MSEC = SAVER_SLEEP_BETWEEN_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_BEETWEEN_CONSTITUENT_MSEC = SAVER_SLEEP_BETWEEN_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_BETWEEN_NEIGHBORHOOD_MSEC = SAVER_SLEEP_BETWEEN_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_BETWEEN_MOTION_MSEC = SAVER_SLEEP_BETWEEN_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_BETWEEN_JUSTIFICATION_MSEC = SAVER_SLEEP_BETWEEN_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_BETWEEN_RECOMMENDATION_TESTER_MSEC = SAVER_SLEEP_BETWEEN_OBJECTS_MSEC; 
	...
	public static final long SAVER_SLEEP_WAITING_ORGANIZATION_MSEC = SAVER_SLEEP_WAITING_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_WAITING_CONSTITUENT_MSEC = SAVER_SLEEP_WAITING_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_WAITING_NEIGHBORHOOD_MSEC = SAVER_SLEEP_WAITING_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_WAITING_MOTION_MSEC = SAVER_SLEEP_WAITING_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_WAITING_JUSTIFICATION_MSEC = SAVER_SLEEP_WAITING_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_WAITING_RECOMMENDATION_TESTER_MSEC = SAVER_SLEEP_WAITING_OBJECTS_MSEC; 
	public static final long SAVER_SLEEP_WAITING_DIRS_MSEC = net.ddp2p.common.hds.DirectoryServerCache.D_Directory_Storage.SaverThread.SAVER_SLEEP;
	/**
	 * 
	 */
	...
	public static int getNumberRunningSaverWaitingItems() {
		return 0 + D_Peer.getNumberItemsNeedSaving() 
				+ D_Organization.getNumberItemsNeedSaving()
