...
public class SaverThreadsConstants {
	...
	public static final long SAVER_SLEEP_WAITING_DIRS_MSEC = net.ddp2p.common.hds.DirectoryServerCache.D_Directory_Storage.SaverThread.SAVER_SLEEP;// SAVER_SLEEP_WAITING_OBJECTS_MSEC;
