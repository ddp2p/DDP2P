 ...
 */
	...
	public static D_OrgParam  init(D_OrgParam op, ArrayList<Object> fe) throws P2PDDSQLException {
			op.global_field_extra_ID = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_GID));
			op.label = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_LABEL));
			op.label_lang= Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_LABEL_L));
			op.can_be_provided_later = Util.stringInt2bool(Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_LATER)), false);
			op.certificated = Util.stringInt2bool(Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_CERT)), false);
			try{op.entry_size = Integer.parseInt(Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_SIZE)));}catch(NumberFormatException e){op.entry_size = 0;}
			try{op.partNeigh = Integer.parseInt(Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_NEIGH)));}catch(NumberFormatException e){op.partNeigh = 0;}
			op.required = Util.stringInt2bool(Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_REQ)), false);
			op.default_value = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_DEFAULT));
			op.default_value_lang = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_DEFAULT_L));
			try{op.list_of_values = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_LIST_VAL)).split(Pattern.quote(net.ddp2p.common.table.organization.ORG_VAL_SEP));}catch(Exception e){}
			op.list_of_values_lang = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_LIST_VAL_L));
			op.tip = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_TIP));
			op.tip_lang = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_TIP_L));
			op.oid = Util.string2BIOID(Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_OID)));
			op.version = Util.getString(fe.get(net.ddp2p.common.table.field_extra.OPARAM_VERSION));
			op.field_LID = Util.lval(fe.get(net.ddp2p.common.table.field_extra.OPARAM_EXTRA_FIELD_ID));
	...
	public static String makeGID(
		...
		return net.ddp2p.common.data.D_GIDH.d_OrgExtraFieldSign+Util.stringSignatureFromByte(enc.getBytes());
	}
}