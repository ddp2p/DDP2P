...
public class D_PeerInstance extends ASNObj {
	...
	static String sql_peer = 
			...
			" WHERE "+net.ddp2p.common.table.peer_instance.peer_ID+" = ?;";
	...
	long store() throws P2PDDSQLException {
		...
		if (this.peer_instance_ID == null)
			...
			params = new String[net.ddp2p.common.table.peer_instance.FIELDS];
		params[net.ddp2p.common.table.peer_instance.PI_PEER_ID] = _peer_ID;
		params[net.ddp2p.common.table.peer_instance.PI_PEER_INSTANCE] = peer_instance;
		params[net.ddp2p.common.table.peer_instance.PI_PEER_BRANCH] = branch;
		params[net.ddp2p.common.table.peer_instance.PI_PEER_AGENT_VERSION] = agent_version;
		params[net.ddp2p.common.table.peer_instance.PI_PLUGIN_INFO] = get_PluginInfo();
		params[net.ddp2p.common.table.peer_instance.PI_OBJECTS_SYNCH] = ""+objects_synchronized;
		params[net.ddp2p.common.table.peer_instance.PI_LAST_SYNC_DATE] = _last_sync_date;
		params[net.ddp2p.common.table.peer_instance.PI_LAST_RESET] = _last_reset;
		params[net.ddp2p.common.table.peer_instance.PI_LAST_CONTACT_DATE] = _last_contact_date;
	...
	public D_PeerInstance(ArrayList<Object> k) {
		this.createdLocally = Util.stringInt2bool(k.get(net.ddp2p.common.table.peer_instance.PI_CREATED_LOCALLY), false);
		peer_instance_ID = Util.getString(k.get(net.ddp2p.common.table.peer_instance.PI_PEER_INSTANCE_ID));
		_peer_ID = Util.getString(k.get(net.ddp2p.common.table.peer_instance.PI_PEER_ID));
		peer_ID = Util.lval(_peer_ID, -1);
		peer_instance = Util.getString(k.get(net.ddp2p.common.table.peer_instance.PI_PEER_INSTANCE));
