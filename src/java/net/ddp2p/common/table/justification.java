...
public class justification {
	 ...
	 public static final String subsumes_LID = "subsumes_LID";
	...
	public static final int J_SUBSUMES_LID = 7;	
	public static final int J_CONSTITUENT_ID = 8;
	public static final int J_TEXT_FORMAT = 9;
	public static final int J_TEXT = 10;
	public static final int J_SIGNATURE = 11;
	public static final int J_REFERENCE = 12;
	public static final int J_CREATION = 13;
	public static final int J_ARRIVAL = 14;
	public static final int J_REQUESTED = 15;
	public static final int J_BLOCKED = 16;
	public static final int J_BROADCASTED = 17;
	public static final int J_TEMPORARY = 18;
	public static final int J_PEER_SOURCE_ID = 19;
	public static final int J_PREFERENCES_DATE = 20;
	public static final int J_HIDDEN = 21;
	public static final int J_ORG_ID = 22;
	public static final int J_ID = 23;
