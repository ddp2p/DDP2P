...
public class Peers extends JTable implements Peers_View, MouseListener, PeerListener {
	...
	public PrivateOrgPanel privateOrgPanel; 
	...
	public boolean registerPlugin(
		...
		int columns = this.getModel().columnNames.length;
		...
		if(crt < model_columns) {
			if(crt == columns-1) {
				...
				try{
					TableColumn c = this.getColumn(cl); 
...
class PeersDeleteAction extends DebateDecideAction {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	String peerID = peer.getLIDstr_keep_force(); 
...
class PeersRowAction extends DebateDecideAction {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	case Peers.COMMAND_MENU_SET_MYSELF:
    		...
    		try {
    			D_Peer me_peer = D_Peer.getPeerByLID(peerID, true, true);
				...
				HandlingMyself_Peer.setMyself_currentIdentity_announceDirs(me_peer, true, true); 
...
class PeersModel extends AbstractTableModel implements TableModel, DBListener {
	...
	public static final int TABLE_COL_VERIF_NAME = 1;
	public static final int TABLE_COL_SERVING = 2;
	public static final int TABLE_COL_CONNECTION = 3;
	public static final int TABLE_COL_BROADCASTED = 4;
	public static final int TABLE_COL_BLOCKED = 5;
	public static final int TABLE_COL_HIDDEN = 6;
	public static final int TABLE_COL_VALID = 7;
	public static final int TABLE_COL_TEMP = 8;
	public static final int TABLE_COL_REVOKED = 9;
	public static final int TABLE_COL_EMAIL = 10;
	public static final int TABLE_COL_VERIF_EMAIL = 11;
	public static final int TABLE_COL_CATEGORY = 12;
	public static final int TABLE_COL_SLOGAN = 13;
	public static final int TABLE_COL_PROVIDER = 14;
	public static final int TABLE_COL_LAST = 15;
	public static final int TABLE_COL_PLUGINS = 16;
