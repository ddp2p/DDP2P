...
public class ConsultingRecommendationsPanel extends JPanel implements ActionListener {
    ...
    public JPanel bodyPanel(){
        ...
        usedTestersTableConstraints.weightx=0.0; 
        knownTestersTableConstraints.anchor = GridBagConstraints.WEST;
        knownTestersTableConstraints.gridwidth = 1;
        knownTestersTableConstraints.weightx=0.0; 
        knownTestersTableConstraints.insets = new Insets(1, 15, 1, 15); 
        ...
        recommendationsTableConstraints.weightx=0.0; 
        recommendationsTableConstraints.insets = new Insets(1, 15, 1, 15); 
