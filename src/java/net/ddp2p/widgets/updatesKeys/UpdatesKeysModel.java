...
public class UpdatesKeysModel extends AbstractTableModel implements TableModel, DBListener {
	...
	public static final int TABLE_COL_WEIGHT = 1; 
	public static final int TABLE_COL_REFERENCE = 2; 
	public static final int TABLE_COL_TRUSTED_TESTER = 3; 
	public static final int TABLE_COL_TRUSTED_MIRROR = 4; 
	...
	public ArrayList<D_Tester> data = new ArrayList<D_Tester>(); 
	public UpdatesKeysModel(DBInterface _db) { 
		db = _db;
	...
	public Class<?> getColumnClass(int col) {
		...
		if(col == this.TABLE_COL_NAME) return String.class;
		return String.class;
	}
	@Override
