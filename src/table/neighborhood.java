...
public class neighborhood {
	 ...
	 public static final int IDX_BLOCKED = 19;
	 public static final int IDX_REQUESTED = 20;
	 public static final int IDX_BROADCASTED = 21;
	 public static final int IDX_ID = 22;
	 public static final String FIELDS_SEP = ",";
	 //public static int IDX_FIELDs=fields_neighborhoods.split(FIELDS_SEP).length;
	 public static int IDX_FIELDs = fields_neighborhoods.split(",").length;//23;
}
