...
//  public final static String PREFERENCES_CONTENTEXTRACTOR = "jar:/org/jpedal/examples/viewer/res/preferences/ContentExtractor.xml";
  ...
  private static String rawFile="@EMBEDDEDFILE@";
    public static String file="@EMBEDDEDFILE@";
    //<start-wrap>
    /**
    //<end-wrap>
...
//            try{
//                in = Viewer.class.getClassLoader().getResourceAsStream("org/mozilla/javascript/Context.class");
//            }catch(Error err){
//            }catch(Exception ex){
//
//            }
...
//        }
        ...
        if(!suppressViewerPopups){
            ...
            boolean showItextMessage = (!propValue.isEmpty() && propValue.equals("true"));
