...
java $ICON -cp "${DIR_ALL}/jars/DD.jar:${DIR_ALL}/jars/javax.mail.jar:${DIR_ALL}/jars/sqlite-jdbc-3.7.2.jar:${DIR_ALL}/jars/MultiSplit.jar:${DIR_ALL}/jars/sqlite4java.jar:${DIR_ALL}/jars/icepdf-core.jar:${DIR_ALL}/jars/icepdf-viewer.jar:${DIR_ALL}/jars/MetaphaseEditor-1.0.0.jar:${DIR_ALL}/:./" -Djava.net.preferIPv4Stack=true config.DD -d ${DIR_ALL}/deliberation-app.db $1 $2 $3 $4 $5
