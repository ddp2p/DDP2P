...
public class Queries{
	...
	public final static int IFN_COUNT = 3;
	public final static int IFN_DEFAULT = 4;
	public final static int IFN_SK = 5;
	public final static int IFN_S_CRED = 6;
	public final static int IFN_PK = 7;
