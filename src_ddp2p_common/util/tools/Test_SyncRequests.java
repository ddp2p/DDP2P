...
class Test_SyncRequests {
	...
	public static void _main(String args[]) throws P2PDDSQLException, ASN1DecoderFail {
		...
		hds.ASNSyncRequest payload_good = new hds.ASNSyncRequest().decode(new Decoder(g));
		hds.ASNSyncRequest payload_wrong = new hds.ASNSyncRequest().decode(new Decoder(w));
