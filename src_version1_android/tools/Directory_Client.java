...
class Directory_Client {
	...
	public static void _main(String args[]) throws Exception{
		...
		if(addr==null) return;
		if("a".equals(op)) announce(domain, port, hash, addr, dir_address);
		if("u".equals(op)) announceUDP(domain, port, hash, addr, dir_address);
	}
	...
	public static void announce(String domain, int port, String hash, String addr, String dir_address)
			throws Exception{
		Socket s = new Socket();
		InetSocketAddress isa = new InetSocketAddress(domain, port);
		System.out.println("Try: "+isa);
	...
	public static void announceUDP(String domain, int port, String hash,
			String addr, String dir_address)
			throws Exception{
		DatagramSocket s = new DatagramSocket();
		InetSocketAddress isa = new InetSocketAddress(domain, port);
		System.out.println("Try: "+isa);
