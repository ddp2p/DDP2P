...
public class DD_IdentityVerification_Answer extends ASNObj implements StegoStructure, DD_EmailableAttachment{
	...
	public void save() throws P2PDDSQLException {
		...
		if((_my_r==null) || !my_r.equals(this.r)){
			Application_GUI.warning(_("We have not generated this request:")+"\n"+this, _("Constituent Verification"));
			return;
		}
		
		boolean v=false;
		if(v=verifySign()) {
			Application_GUI.warning(_("Successfull verification of:")+this, _("Constituent Verification"));
		}else{
			Application_GUI.warning(_("Failed verification of:")+this, _("Constituent Verification"));
		}
	...
	public String get_To() {
		if((verifier==null)||(verifier.component_basic_data.emails==null)){
			Application_GUI.warning(_("No emails set in peer!"), _("Destination email absent"));
	...
	public String get_From() {
		if((verified==null)||(verified.email==null)){
			Application_GUI.warning(_("No emails set in this constituent!"), _("Your email absent"));
	...
	public static void main(String args[]){
		try {
			...
			a.verifier = D_Peer.getPeerByLID(1, true);
