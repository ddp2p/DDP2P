...
public class DD_IdentityVerification_Request extends ASNObj implements StegoStructure, DD_EmailableAttachment {
	...
	public Encoder getEncoder() {
		...
		if(verified==null){
			Application_GUI.warning(_("Unknown constituent to verify!"), _("Verifying Constituent"));
	...
	public DD_IdentityVerification_Request decode(Decoder dec) throws ASN1DecoderFail {
		...
		if(type_verifier == D_Peer.getASN1Type()) {
			verifier = new D_Peer().decode(d.getFirstObject(true));
	...
	public void save() throws P2PDDSQLException {
		...
		if(sk == null){
			Application_GUI.warning(_("I do not have the secret key for:")+"\n"+this,
		...
		if(!mine.LocallyAvailable()){
			Application_GUI.warning(_("I do not have the constituent:")+"\n"+this,
					_("Identity Verification"));
			return;
		}
		if((!mine.global_constituent_id.equals(this.verified.global_constituent_id))||
			...
			Application_GUI.warning(_("Inconsistent Global Identifiers:")+
		...
		Application_GUI.info(
           			...
           			_("Handling Verification Request"));
		//EmailManager.
	...
	public String get_To() {
		if((verified==null)||(verified.email==null)){
			Application_GUI.warning(_("No emails set in this constituent!"), _("Destination email absent"));
			return Application_GUI.input(_("Can you enter the destination email?"), _("Destination"),
					Application_GUI.QUESTION_MESSAGE);
			//return "unknown@unknown";
		}
		return Application_GUI.input(_("Enter an email that you personally know for this claimed identity?")+
	...
	public String get_From() {
		if((verifier==null)||(verifier.component_basic_data.emails==null)){
			Application_GUI.warning(_("No emails set in your peer!"), _("Sender email absent"));
			return Application_GUI.input(_("Can you enter the sender email?"), _("Sender"),
					Application_GUI.QUESTION_MESSAGE);
			// return "unknown@unknown";
		}
