...
public class AddSafe extends ActionBarActivity {
	...
	class PeerCreatingThread extends Thread {
		...
		public D_Peer gen() {
			...
			if (myself == null) {
				Toast.makeText(getApplicationContext(), "Could not set slogan/email", Toast.LENGTH_SHORT).show();
				return peer;
			}
	 ...
	 private final Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
    	        ...
    	        Toast.makeText(AddSafe.this, "add a new safe successfully!", Toast.LENGTH_LONG).show();
        }
	 };
}
